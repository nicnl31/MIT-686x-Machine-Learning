...
final_T = 25
final_L = 0.01
accuracies_params = p1.classifier_accuracy(p1.pegasos,
                                           train_bow_features,
                                           test_bow_features,
                                           train_labels,
                                           test_labels,
                                           T=final_T,
                                           L=final_L)
print(f"Training accuracy: {accuracies_params[0]}")
print(f"Testing accuracy: {accuracies_params[1]}")
...
best_theta = accuracies_params[2]
