...
def most_explanatory_word(theta, wordlist):
    """Returns the word associated with the bag-of-words feature having the largest weight."""
    return [word for (theta_i, word) in sorted(zip(theta, wordlist))[::-1]]  # change the step \
    # from -1 to 1 to get the most negative words
